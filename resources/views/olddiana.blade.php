    ...
    <body>
        ...
        <nav>
            <div class="col-md-6 col-sm-6">
                <img src="{{ asset('/images/diana_logo.png') }}" width="120px;">
            </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="topnav" id="myTopnav">
                    ...
                    <a href="#company_body" id="company_menu">ABOUT US</a>
                    <a href="#gallery_body" id="gallery_menu">PRODUCT</a>
                    <a href="#product_body" id="product_menu">PROJECT</a>
                    <a href="#news_body" id="contact_menu">NEWS</a>
                    <a href="#career_body" id="contact_menu">CAREER</a>
        ...
        <div class="container-fluid">
            <!-- home -->
            <div id="home_body">
                <div class="row text_bg">
                        <div class="col-md-6 col-sm-6">
                                <b style="font-size:56px;font-family: 'asenpro';color:#ffffff;">Solusi Inovatif Kebutuhan<br><i>Kaca</i> untuk Proyek Anda</b>
                        </div>
                        <div class="col-md-6 col-sm-6">
